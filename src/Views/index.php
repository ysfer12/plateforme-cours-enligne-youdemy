        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-8">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="#" class="px-4 py-2 text-blue-600 rounded-lg hover:bg-blue-50 transition">
                            Connexion
                        </a>
                        <a href="#" class="px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:opacity-90 transition">
                            Inscription
                        </a>
                    </div>
                </div>
